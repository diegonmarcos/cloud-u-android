...
package com.diegonmarcos.mediacenter.core.backup
...
/** A cloud server configuration. Mirrors [com.diegonmarcos.mediacenter.cloud.data.entity.CloudServerConfigEntity]. */
@Serializable
...
/**
 * Metadata of a single vault media item. Mirrors [com.diegonmarcos.mediacenter.feature_node.domain.model.Media.EncryptedMedia2].
