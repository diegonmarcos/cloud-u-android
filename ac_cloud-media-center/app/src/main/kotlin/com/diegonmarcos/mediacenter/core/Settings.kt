...
import com.diegonmarcos.mediacenter.core.Constants.albumCellsList
import com.diegonmarcos.mediacenter.core.Constants.cellsList
import com.diegonmarcos.mediacenter.core.Constants.mosaicColumnsList
import com.diegonmarcos.mediacenter.core.Settings.Misc.CURRENT_SETUP_VERSION
...
import com.diegonmarcos.mediacenter.core.presentation.components.FilterKind
...
import com.diegonmarcos.mediacenter.core.util.rememberPreference
import com.diegonmarcos.mediacenter.core.util.rememberPreferenceSerializable
import com.diegonmarcos.mediacenter.feature_node.domain.model.SearchHistory
import com.diegonmarcos.mediacenter.feature_node.domain.model.SelectionSheetConfig
import com.diegonmarcos.mediacenter.feature_node.domain.model.SlideshowTransition
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.slideshow.SlideshowConfig
import com.diegonmarcos.mediacenter.feature_node.domain.util.OrderType
import com.diegonmarcos.mediacenter.feature_node.presentation.library.components.LibraryShortcutPref
    ...
    object Misc {
        ...
        fun rememberStoryCardsConfig() =
            rememberPreferenceSerializable(
                ...
                defaultValue = com.diegonmarcos.mediacenter.feature_node.domain.model.StoryCardsConfig()
            )

        fun getStoryCardsConfig(context: Context) =
            context.activeDataStore.data.map {
                it[STORY_CARDS_CONFIG]?.let { json ->
                    runCatching { Json.decodeFromString<com.diegonmarcos.mediacenter.feature_node.domain.model.StoryCardsConfig>(json) }.getOrNull()
                } ?: com.diegonmarcos.mediacenter.feature_node.domain.model.StoryCardsConfig()
            }
