...
import cld.camera.R
import cld.camera.VIDEO_NAME_PREFIX
...
import cld.camera.util.formatVideoDuration
import cld.camera.util.getTreeDocumentUri
import cld.camera.util.removePendingFlagFromUri
