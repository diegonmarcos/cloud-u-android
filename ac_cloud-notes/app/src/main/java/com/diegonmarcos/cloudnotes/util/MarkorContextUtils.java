...
import com.diegonmarcos.cloudnotes.activity.openeditor.OpenEditorQuickNoteActivity;
import com.diegonmarcos.cloudnotes.activity.openeditor.OpenEditorTodoActivity;
import com.diegonmarcos.cloudnotes.activity.openeditor.OpenFromShortcutOrWidgetActivity;
import com.diegonmarcos.cloudnotes.activity.openeditor.OpenShareIntoActivity;
...
public class MarkorContextUtils extends GsContextUtils {
    ...
    public <T extends GsContextUtils> T applySpecialLaunchersVisibility(final Context context, boolean extraLaunchersEnabled) {
        ...
        setLauncherActivityEnabledFromString(context, "com.diegonmarcos.cloudnotes.AliasDocumentProcessText", extraLaunchersEnabled);
        return thisp();
    }
