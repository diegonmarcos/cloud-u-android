# ─── GENERATED: do not edit — edit 1_cicd/src/scripts/cloud-notes-engine.sh ───
#!/usr/bin/env bash
# ╔══════════════════════════════════════════════════════════════════╗
# ║ cloud-notes-engine — Cloud Notes from the vendored AFFiNE        ║
# ║                                                                  ║
# ║ AFFiNE is vendored at the app root (ac_cloud-notes/, no .git).  ║
...
# ║                                                                  ║
# ║ Vendored as ac_cloud-notes/build.sh (build.json::vendored_engine)║
